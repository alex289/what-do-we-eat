...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between w-full max-w-4xl p-3 mx-auto my-0 text-gray-900 md:p-0 bg-gray-50 sticky-nav bg-opacity-60 md:my-8 dark:bg-gray-900 dark:text-gray-100">
      <div>
